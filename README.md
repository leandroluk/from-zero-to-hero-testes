...
4. Crie os diretórios que compõem uma estrutura básica de uma aplicação NodeJS e que é comumente utilizada em projetos pela comunidade:
    ...
    - <u>tests:</u> diretório onde se mantém os códigos de configuração
...
5. Configure os script's de testes do projeto conforme o arquivo abaixo:
    ...
    ```json
    {
      "scripts": {
        /*
        - Executa os tests usando o mocha, procurando por 
          testes no diretório "./tests" e que tenham os 
          pós-fixos ".spec.js" ou ".test.js".
        - Além disso, com o comando "--exit" ele força que 
          os testes sejam encerrados mesmo que ainda existam 
          processos em execução.
        - No final define o timeout de cada teste em 10 segundos 
          com o comando "-t 10000"
        */
        "test": "mocha tests/**/*.{spec,test}.js --exit -t 10000",
        /*
...
> Essas denominações são análogas a stack's de desenvolvimento (como Angular, React, Vue, etc) e a stack's de teste (como a apresentada agora ou o Jest).
